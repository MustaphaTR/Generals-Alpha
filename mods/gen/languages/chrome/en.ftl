...
label-minimal-stats-collectors-header = Coll.
...
label-economy-stats-collectors-header = Collectors
...
label-gps-and-upgrades-player-header = Player
label-gps-and-upgrades-header = GPs and Upgrades
...
button-command-bar-force-attack =
   ...
   .tooltipdesc = Selected units will attack the targeted unit or location
     ...
     - Several units use alternate weapons for force attack
...
button-production-types-generals-powers-tooltip = General's Powers
