modcontent-installprompt =
    Generals Alpha requires artwork and audio of original Red Alert.
...
modcontent-header =
    Game content may be extracted from the original Red Alert discs or an existing digital install. OpenRA can also download the base game files from an online mirror of the 2008 freeware release of RA.
...
modcontent-package-generalsmusic = Generals Music
